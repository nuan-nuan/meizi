package io.github.nuannuan.network;
...
import io.github.nuannuan.network.builder.GetBuilder;
import io.github.nuannuan.network.builder.PostFileBuilder;
import io.github.nuannuan.network.builder.PostFormBuilder;
import io.github.nuannuan.network.builder.PostStringBuilder;
import io.github.nuannuan.network.callback.Callback;
import io.github.nuannuan.network.cookie.SimpleCookieJar;
import io.github.nuannuan.network.https.OKHttpsUtils;
...
public class OkHttpUtils {
    ...
    public void setCertificates(InputStream... certificates) {
        mOkHttpClient = getOkHttpClient().newBuilder()
                .sslSocketFactory(OKHttpsUtils.getSslSocketFactory(certificates, null, null))
                .build();
    }
